...
#define R_386_TLS_DESC_CALL 40		/* Marker of call through TLS descriptor forrelaxation.  */
...
#define R_390_TLS_IEENT		49	/* 32 bit rel. offset to GOT entry for nnegated static TLS block offset.  */
