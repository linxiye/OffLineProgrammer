...
#define ENDP4_ADDR        (ENDP3_TXADDR + 0x40)
#define ENDP5_ADDR        (ENDP4_ADDR + 0x40)
...
struct ch32_usb{
    ...
    void (*CDC_In_Callback)(uint8_t *data,uint32_t len);
    void (*CDC_Out_Callback)(uint8_t *data,uint32_t len);
};
